...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 11, 2026 at 04:48 AM
...
(14, NULL, 'rico', 'rico@gmail.com', '09112456789', 'Announcement: Libre Tuli', '2026-03-15', '10:00:00', '13:00:00', 'ANN-69B0D4EA1D6D9', '2026-03-11 02:35:22.125540', 'ACCEPTED'),
(15, NULL, 'rico', 'rico@gmail.com', '09112456789', 'Announcement: Libre', '2026-03-15', '09:00:00', '10:00:00', 'ANN-69B0D7563787A', '2026-03-11 02:45:42.232987', 'ACCEPTED'),
(16, NULL, 'rico', 'rico@gmail.com', '09112456789', 'Announcement: Sample', '2026-03-15', '08:00:00', '09:00:00', 'ANN-69B0D89E79B71', '2026-03-11 02:51:10.501896', 'ACCEPTED'),
(17, NULL, 'rico', 'rico@gmail.com', '09112456789', 'Announcement: Sample', '2026-03-15', '13:00:00', '14:00:00', 'ANN-4E1079D4', '2026-03-11 03:20:42.631890', '');
...
INSERT INTO `announcements` (`announcements_id`, `title`, `message`, `date`, `start_time`, `end_time`) VALUES
(17, 'Libre Tuli', 'Libre tuli karung ugma sa buntag', NULL, NULL, NULL),
(18, 'Libre', 'tuli', NULL, NULL, NULL),
(19, 'Sample', '123', NULL, NULL, NULL),
(23, 'Sample', 'asd', '2026-03-15', '13:00:00', '14:00:00');
...
(62, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 13:34:22'),
(63, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 13:35:02'),
(64, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 13:37:39'),
(65, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 14:38:57'),
(66, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 14:43:18'),
(67, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 14:46:31'),
(68, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 14:58:06'),
(69, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36 Edg/145.0.0.0', '2026-03-10 14:58:26'),
(70, 15, 'admin123', 'admin', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '2026-03-11 02:27:57');
...
--
ALTER TABLE `missed_bookings`
  MODIFY `missed_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `accepted_bookings`
  ADD CONSTRAINT `fk_accepted_reservations` FOREIGN KEY (`reservation_id`) REFERENCES `reservations` (`reservation_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `booking_history`
--
ALTER TABLE `booking_history`
  ADD CONSTRAINT `fk_booking_history_users` FOREIGN KEY (`users_id`) REFERENCES `users` (`users_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `denied_bookings`
  ADD CONSTRAINT `fk_denied_reservations` FOREIGN KEY (`reservation_id`) REFERENCES `reservations` (`reservation_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `login_logs`
--
ALTER TABLE `login_logs`
  ADD CONSTRAINT `fk_login_logs_users` FOREIGN KEY (`users_id`) REFERENCES `users` (`users_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
-- Constraints for table `missed_bookings`
--
ALTER TABLE `missed_bookings`
  ADD CONSTRAINT `fk_missed_reservations` FOREIGN KEY (`reservation_id`) REFERENCES `reservations` (`reservation_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
